create database dbt default character set utf8mb4 default collate utf8mb4_general_ci;
use dbt;
...
select * from customer inner join orders on orders.custid = customer.custid;
